...
public class QuestTaskMob extends QuestTask {
    ...
    public void onLivingDeath(LivingDeathEvent event) {
        ...
        if (player != null && parent.isEnabled(player)
            && parent.isAvailable(player)
    ...
    public void draw(GuiQuestBook gui, EntityPlayer player, int mX, int mY) {
        ...
        for (int i = 0; i < mobs.length; i++) {
            ...
            if (killed == mob.count) {
                gui.drawString(
                    GuiColor.GREEN + Translator.translate("hqm.mobTask.allKilled"),
                ...
                gui.drawString(
                    Translator.translate("hqm.mobTask.partKills", killed, (100 * killed / mob.count)),
                    x + X_TEXT_OFFSET + X_TEXT_INDENT,
                    y + Y_TEXT_OFFSET + 9,
                    0.7F,
                    0x404040);
            ...
            gui.drawString(
                Translator.translate("hqm.mobTask.totalKills", mob.count),
                x + X_TEXT_OFFSET + X_TEXT_INDENT,
                y + Y_TEXT_OFFSET + 15,
                0.7F,
                0x404040);
