...
public abstract class QuestTask {
    ...
    public QuestDataTask getData(String playerName) {
        QuestData questData = QuestingData.getQuestingData(playerName)
            .getQuestData(parent.getId());
    ...
    private QuestDataTask newQuestData() {
        try {
            Constructor<? extends QuestDataTask> constructor = getDataType()
    ...
    public static void completeQuest(Quest quest, String playerName) {
        ...
        if (QuestingData.getQuestingData(playerName)
            .getTeam()
            .getRewardSetting() == Team.RewardSetting.RANDOM) {
        ...
        if (quest.getRepeatInfo()
            .getType() == RepeatType.INSTANT) {
