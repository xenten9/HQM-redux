...
public enum RepeatType {
    ...
    INSTANT("instant", false) {
        ...
        @Override
        public String getMessage(Quest quest, EntityPlayer player, int days, int hours) {
            return super.getMessage(quest, player, days, hours) + GuiColor.GRAY
                + Translator.translate("hqm.repeat.instant.message");
        }
    ...
    INTERVAL("interval", true) {
        ...
        public String getMessage(Quest quest, EntityPlayer player, int days, int hours) {
            return super.getMessage(quest, player, days, hours) + GuiColor.GRAY
                + Translator.translate("hqm.repeat.interval.message")
                + "\n"
        ...
        @Override
        public String getShortMessage(int days, int hours) {
            return GuiColor.YELLOW + Translator
                .translate("hqm.repeat.interval.message") + " (" + days + ":" + hours + ")";
        }
    },
    TIME("time", true) {
        ...
        public String getMessage(Quest quest, EntityPlayer player, int days, int hours) {
            return super.getMessage(quest, player, days, hours) + GuiColor.GRAY
                + Translator.translate("hqm.repeat.time.message")
                + "\n"
                + formatTime(days, hours)
                + formatRemainingTime(quest, player, days, hours);
        }
