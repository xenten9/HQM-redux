...
public class ItemHeart extends Item {
    ...
    public void getSubItems(Item item, CreativeTabs creativeTabs, List stackList) {
        for (int x = 0; x < ItemInfo.HEART_ICONS.length; x++) stackList.add(new ItemStack(this, 1, x));
    }
    ...
    public ItemStack onItemRightClick(ItemStack item, World world, EntityPlayer player) {
        if (!world.isRemote) {
            ...
            if (item.getItemDamage() == 3) {
                ...
                } else if (QuestingData.getQuestingData(player)
                    .getRawLives() < ModConfig.MAXLIVES) {
                        ...
                        player.addChatComponentMessage(
                            Translator.translateToIChatComponent("hqm.message.haveRemaining", lives));
                        ...
                        player
                            .addChatComponentMessage(Translator.translateToIChatComponent("hqm.message.haveMaxLives"));
                    }
            }
            ...
            if (itemStack.getItemDamage() == 3 && ModConfig.ROTTIMER) {
                ...
                if (!tagCompound.hasKey("RotTime")) {
                    ...
                    if (newRot <= 0) {
                        ...
                        entityPlayer
                            .addChatComponentMessage(Translator.translateToIChatComponent("hqm.message.hearthDecay"));
                    } else {
