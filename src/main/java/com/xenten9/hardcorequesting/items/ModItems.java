...
public class ModItems {
    ...
    public static void registerRecipes() {
        ...
        GameRegistry.addShapelessRecipe(
            new ItemStack(hearts, 1, 3),
            new Object[] { new ItemStack(hearts, 1, 0), new ItemStack(hearts, 1, 0), new ItemStack(hearts, 1, 0),
                new ItemStack(hearts, 1, 0) });

        // 1-1-2
        GameRegistry.addShapelessRecipe(
            new ItemStack(hearts, 1, 3),
            new Object[] { new ItemStack(hearts, 1, 0), new ItemStack(hearts, 1, 0), new ItemStack(hearts, 1, 1) });

        // 1-3
        GameRegistry.addShapelessRecipe(
            new ItemStack(hearts, 1, 3),
            new Object[] { new ItemStack(hearts, 1, 0), new ItemStack(hearts, 1, 2) });

        // 2-2
        GameRegistry.addShapelessRecipe(
            new ItemStack(hearts, 1, 3),
            new Object[] { new ItemStack(hearts, 1, 1), new ItemStack(hearts, 1, 1) });

        // 1-1
        GameRegistry.addShapelessRecipe(
            new ItemStack(hearts, 1, 1),
            new Object[] { new ItemStack(hearts, 1, 0), new ItemStack(hearts, 1, 0) });

        // 1-1-1
        GameRegistry.addShapelessRecipe(
            new ItemStack(hearts, 1, 2),
            new Object[] { new ItemStack(hearts, 1, 0), new ItemStack(hearts, 1, 0), new ItemStack(hearts, 1, 0) });

        // 1-2
        GameRegistry.addShapelessRecipe(
            new ItemStack(hearts, 1, 2),
            new Object[] { new ItemStack(hearts, 1, 0), new ItemStack(hearts, 1, 1) });
