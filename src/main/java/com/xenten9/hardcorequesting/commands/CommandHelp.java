        ...
        switch (arguments.length) {
            case 0:
                ...
                for (int i = 0; i < commands.size() - 1; i++) {
                    output.append("/")
                        .append(CommandHandler.instance.getCommandName())
                        .append(" ")
                        .append(YELLOW)
                ...
                output.append(" and /")
                    ...
                    .append(" ")
                    .append(YELLOW)
                    .append(commands.get(commands.size() - 1))
                    .append(WHITE)
                    .append(".");
            ...
            case 1:
                ...
                if (command.isVisible(sender)) {
                    for (int i : command.getSyntaxOptions(sender)) sender.addChatMessage(
                        new ChatComponentText(
                            YELLOW + Translator.translate(Lang.COMMAND_PREFIX + commandName + Lang.SYNTAX_SUFFIX + i)
                                + WHITE
                                + " - "
                                + Translator.translate(Lang.COMMAND_PREFIX + commandName + Lang.INFO_SUFFIX + i)));
                } else {
