...
import com.xenten9.hardcorequesting.quests.RepeatInfo;
import com.xenten9.hardcorequesting.quests.RepeatType;
...
public class GuiEditMenuRepeat extends GuiEditMenuExtended {
    ...
    public GuiEditMenuRepeat(GuiQuestBook gui, EntityPlayer player, Quest quest) {
        ...
        this.quest = quest;
        this.type = quest.getRepeatInfo()
            .getType();
        days = quest.getRepeatInfo()
            .getDays();
        hours = quest.getRepeatInfo()
            .getHours();
        ...
        textBoxes.add(new TextBoxHidden(gui, 1, "hqm.repeatMenu.hours") {
            ...
            protected void draw(GuiBase gui, boolean selected) {
                ...
                gui.drawString(
                    gui.getLinesFromText(Translator.translate("hqm.repeatMenu.mcDaysHours"), 0.7F, 150),
                    BOX_X,
                    BOX_Y + BOX_OFFSET * 2 + TEXT_OFFSET,
                    0.7F,
                    0x404040);
            }
        });
