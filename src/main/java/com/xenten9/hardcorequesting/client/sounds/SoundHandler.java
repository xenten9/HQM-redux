...
public class SoundHandler {
    ...
    public static boolean loadLoreReading(String path) {
        ...
        if (index == -1) {
            if (new File(path + "lore.ogg").exists()) {
                ...
                Map resourceManagers = ReflectionHelper.getPrivateValue(
                ...
                net.minecraft.client.audio.SoundHandler handler = Minecraft.getMinecraft()
                    .getSoundHandler();
                ...
                Method method = ReflectionHelper.findMethod(
                    net.minecraft.client.audio.SoundHandler.class,
                    handler,
                    new String[] { "loadSoundResource", "func_147693_a", "a" },
    ...
    public static boolean isLorePlaying() {
        boolean value = loreSound != null && Minecraft.getMinecraft()
            .getSoundHandler()
            .isSoundPlaying(loreSound);
