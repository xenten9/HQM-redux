...
public abstract class FileHelper {
    ...
    public enum SaveResult {
        ...
        PRE_CRASH_FAILURE("Double save failure",
    ...
    /**
     * Makes sure that the supplied folder is created, along with all its parent folders. This is to make sure the path
     * actually exists
     *
    ...
    public SaveResult saveData(File file) {
        ...
        try {
            ...
            if (moveUpFileIndices(file.getAbsolutePath() + PRE_CRASH_SUFFIX, 0)) {
                if (backup(
                    new File(file.getAbsolutePath() + BACKUP_SUFFIX),
